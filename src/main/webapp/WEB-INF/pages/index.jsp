...
<head>
<meta charset="utf-8">
<title>Course Manager WebAp2p</title>
...
<body>
  ...
  <script src="${pageContext.request.contextPath}/js/ds/Level.js"></script>
  <script src="${pageContext.request.contextPath}/js/ds/LevelStore.js"></script>
